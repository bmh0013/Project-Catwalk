  ...
  const body = (
    <div style={modalStyle} className={classes.paper}>
      <Grid container direction="column" spacing={1}>
        <Grid item><Typography variant='h4'>Submit your Answer</Typography></Grid>
        <Grid item><Typography variant='h5'>{question}</Typography></Grid>
        <Grid item>
          <form onSubmit={handleSubmit}>
            <Grid container direction="column" spacing={2}>
              <Grid item>
              <InputLabel htmlFor="add-answer-answer">Answer*</InputLabel>
                <TextField id="add-answer-answer"
                  variant="outlined"
